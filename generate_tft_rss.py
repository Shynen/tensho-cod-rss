...
SOURCE_URLS = [
    "https://teamfighttactics.leagueoflegends.com/fr-fr/news/",
]
...
print("")
print("########################################")
print("# Tensho Teamfight Tactics RSS")
...
def load_cache():
    ...
    try:
        ...
        print(
            f"Cache TFT chargé : {len(data)} articles."
        )
...
create_rss(
    OUTPUT,
    "Teamfight Tactics — Actualités",
    "Actualités officielles françaises de Teamfight Tactics.",
    articles
)
...
create_rss(
    DISCORD_OUTPUT,
    "Teamfight Tactics Actualités",
    "Dernière actualité officielle de Teamfight Tactics.",
    articles[:1]
)

print(
    "🟢 tft-news-discord.xml généré."
)
